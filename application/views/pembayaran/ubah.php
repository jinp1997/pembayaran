...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Ubah Data Pembayaran UKT UNIMA</h1>
    <p class="mb-4"></p>
    ...
    <div class="card shadow mb-4 border-bottom-success ">
        ...
        <div class="card-body">
            <form action="<?= site_url('pembayaran/ajax_update/'. $nim . '/' . $semester) ?>" method="post">
                <input type="hidden" name="nim" value="<?= $nim ?>" />  
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label col-form-label-sm" for="tanggal">Tanggal Bayar</label>
                    <div class="col-sm-3">
                        <input type="date" name="tanggal" id="tanggal" value="<?= $tgl ?>" class="form-control form-control-sm" />
                    </div>
                    <div class="col-sm-3">
                        <input type="time" name="jam" id="jam" value="<?= $jam ?>" class="form-control form-control-sm" />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="mhsregSemId" id="mhsregSemId" value="<?= $semester ?>" class="form-control form-control-sm" disabled />
                        <span class="help-block text-danger" style="font-size: 10pt"></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="mhsregTotalBayar" id="mhsregTotalBayar" value="<?= $mhs->mhsregTotalBayar ?>" class="form-control form-control-sm" />
                        <span class="help-block text-danger" style="font-size: 10pt"></span>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="mhsregKeterangan" id="mhsregKeterangan" value="<?= $mhs->mhsregKeterangan ?>" class="form-control form-control-sm" />
                        <span class="help-block text-danger" style="font-size: 10pt"></span>
                    </div>
                </div>
                <hr>

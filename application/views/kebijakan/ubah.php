<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Ubah Data Kebijakan UKT UNIMA</h1>
    <p class="mb-4"></p>
    ...
    <div class="card shadow mb-4 border-bottom-success ">
        ...
        <div class="card-body">
            <form action="<?= site_url('kebijakan/ajax_update/'.$id_kebijakan) ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="number" name="jlh_ukt" id="jlh_ukt" value="<?= $mhs->jlh_ukt ?>" class="form-control form-control-sm" />
                        <span class="help-block text-danger" style="font-size: 10pt"></span>
                    </div>
                </div>
